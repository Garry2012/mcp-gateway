...
### Starting MCP Gateway from git repo
...
* `uvicorn mcpgateway.main:app --host 0.0.0.0 --port 4444 --workers 2 --env-file .env` will start MCP Gateway UI and APIs at http://localhost:4444/docs and toolops API endpoints will be shown.
